...
<span data-picture data-alt="">
  ...
  <li>
<span data-picture data-alt="">
			<span data-src="img/background/ben/bg1-768.jpg"></span>
			<span data-src="img/background/ben/bg1-640.jpg" data-media="(orientation:portrait) and (min-width: 1px) and (max-width: 640px)"></span>
			<span data-src="img/background/ben/bg1-768.jpg" data-media="(orientation:portrait) and (min-width: 641px)"></span>
			<span data-src="img/background/ben/bg1-960.jpg" data-media="(orientation:landscape) and (min-width: 769px) and (max-width:960px)"></span>
			<span data-src="img/background/ben/bg1-1024.jpg" data-media="(orientation:landscape) and (min-width: 961px) and (max-width:1024px) "></span>
			<span data-src="img/background/ben/bg1-1600.jpg" data-media="(orientation:landscape) and (min-width: 1025px)"></span>
				<!-- Fallback content for non-JS browsers. Same img src as the initial, unqualified source element. -->
			<noscript><img src="img/background/bg1-1600.jpg" alt=""></noscript>
		</span>
  </li>
  <li>
<span data-picture data-alt="">
...
<li>
<span data-picture data-alt="">
			<span data-src="img/background/ben/bg2-768.jpg"></span>
			<span data-src="img/background/ben/bg2-640.jpg" data-media="(orientation:portrait) and (min-width: 1px) and (max-width: 640px)"></span>
			<span data-src="img/background/ben/bg2-768.jpg" data-media="(orientation:portrait) and (min-width: 641px)"></span>
			<span data-src="img/background/ben/bg2-960.jpg" data-media="(orientation:landscape) and (min-width: 769px) and (max-width:960px)"></span>
			<span data-src="img/background/ben/bg2-1024.jpg" data-media="(orientation:landscape) and (min-width: 961px) and (max-width:1024px) "></span>
			<span data-src="img/background/ben/bg2-1600.jpg" data-media="(orientation:landscape) and (min-width: 1025px)"></span>
				<!-- Fallback content for non-JS browsers. Same img src as the initial, unqualified source element. -->
			<noscript><img src="img/background/bg2-1600.jpg" alt=""></noscript>
		</span>
  </li>
 <li>
<span data-picture data-alt="">
			<span data-src="img/background/ben/bg5-768.jpg"></span>
			<span data-src="img/background/ben/bg5-640.jpg" data-media="(orientation:portrait) and (min-width: 1px) and (max-width: 640px)"></span>
			<span data-src="img/background/ben/bg5-768.jpg" data-media="(orientation:portrait) and (min-width: 641px)"></span>
			<span data-src="img/background/ben/bg5-960.jpg" data-media="(orientation:landscape) and (min-width: 769px) and (max-width:960px)"></span>
			<span data-src="img/background/ben/bg5-1024.jpg" data-media="(orientation:landscape) and (min-width: 961px) and (max-width:1024px) "></span>
			<span data-src="img/background/ben/bg5-1600.jpg" data-media="(orientation:landscape) and (min-width: 1025px)"></span>
				<!-- Fallback content for non-JS browsers. Same img src as the initial, unqualified source element. -->
			<noscript><img src="img/background/bg5-1600.jpg" alt=""></noscript>
		</span>
  </li>
  <li>
<span data-picture data-alt="">
			<span data-src="img/background/ben/bg6-768.jpg"></span>
			<span data-src="img/background/ben/bg6-640.jpg" data-media="(orientation:portrait) and (min-width: 1px) and (max-width: 640px)"></span>
			<span data-src="img/background/ben/bg6-768.jpg" data-media="(orientation:portrait) and (min-width: 641px)"></span>
			<span data-src="img/background/ben/bg6-960.jpg" data-media="(orientation:landscape) and (min-width: 769px) and (max-width:960px)"></span>
			<span data-src="img/background/ben/bg6-1024.jpg" data-media="(orientation:landscape) and (min-width: 961px) and (max-width:1024px) "></span>
			<span data-src="img/background/ben/bg6-1600.jpg" data-media="(orientation:landscape) and (min-width: 1025px)"></span
				<!-- Fallback content for non-JS browsers. Same img src as the initial, unqualified source element. -->
			<noscript><img src="img/background/bg6-1600.jpg" alt=""></noscript>
		</span>
  </li>
